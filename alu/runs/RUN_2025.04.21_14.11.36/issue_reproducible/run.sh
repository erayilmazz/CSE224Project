...
export CURRENT_DEF='./tmp/cts/13-alu.resized.def';
export CURRENT_NETLIST='./tmp/cts/13-alu.resized.nl.v';
export CURRENT_ODB='./tmp/cts/13-alu.resized.odb';
export CURRENT_POWERED_NETLIST='./tmp/cts/13-alu.resized.pnl.v';
